...
echo "============================================"
echo ""
echo -e "${YELLOW}⚠ 重要：首次打开需要额外一步${NC}"
echo ""
echo "由于应用未经过 Apple 签名，首次打开时"
echo "macOS 会显示安全警告。请按以下步骤操作："
echo ""
echo "  1. 双击打开 MacFanControl.app"
echo "  2. 会显示「无法打开」的安全警告"
echo "  3. 打开「系统设置」→「隐私与安全性」"
echo "  4. 向下滚动到「安全性」区域"
echo "  5. 找到「MacFanControl」并点击「仍要打开」"
echo "  6. 在弹出对话框中点击「打开」"
echo ""
echo "详细图文说明请查看 DMG 中的「安装说明.txt」"
echo ""
