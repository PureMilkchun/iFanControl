...
echo ""
echo -e "${BLUE}╔════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║         iFanControl v2.1 安装程序           ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ ! -d "${SCRIPT_DIR}/iFanControl.app" ]; then
    echo -e "${RED}✗ 错误：找不到 iFanControl.app${NC}"
    exit 1
fi
...
echo ""
echo -e "${YELLOW}[3/4]${NC} 安装 iFanControl.app..."
...
echo -e "${GREEN}✓${NC} iFanControl.app 已安装到 /Applications/"
